...
#### 7. ¿Qué estrategia usaste para verificar que no habían problemas en el código fuente?
 Probandolo y bajando el tamaño de la matriz a 2
...
- [X] Otro (especificar)
Ya habia solucinado el problema del leaderboard pero estaba ejecutando el archivo que no era. me demore casi una hora en darme cuenta.